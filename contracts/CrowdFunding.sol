...
contract Project {
    ...
    * @return projectStarter The address of the project starter.
    * @return projectTitle The title of the project.
    * @return projectDesc The description of the project.
    * @return deadline The deadline of the project.
    * @return currentState The current state of the project.
    * @return currentAmount The current amount raised for the project.
    * @return goalAmount The goal amount for the project.
    */
    function getInfo()
        public view
        returns (
